...
public:
    ...
    explicit KBusyIndicatorWidget(bool useScalable, QWidget *parent = nullptr);
    explicit KBusyIndicatorWidget(bool useScalable, int freezeMs, QWidget *parent = nullptr);
    ...
    int freezeDuration();
    /**
     * run an empty animation
     */
    void setBogus(bool enabled);
    bool bogus();
